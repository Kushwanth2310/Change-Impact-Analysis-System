...
document.addEventListener('DOMContentLoaded', function() {
    // Check if user is logged in and is reviewer
    ...
    if (currentUser.role !== 'reviewer') {
        alert('Access denied. Reviewer privileges required.');
        window.location.href = 'index.html';
        return;
    }
...
function loadRequests() {
    console.log('=== LOADING REQUESTS IN REVIEWER DASHBOARD ===');
    ...
    // Reviewers can see all requests from all users
